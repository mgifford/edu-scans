...
**3,187** of **3,863** available pages scanned (**82.5%** coverage)
**2,398** of **3,187** scanned pages were reachable (**75.2%**)
**1,636** reachable pages loaded at least one third-party script (**68.2%** of reachable)
**2,807** known third-party service loads identified
...
|---------|---------|-----------|-----------|------------------------|--------------------|----------|
| Usa Edu Master | 3,187 | 3,763 | 2,398 | 1,636 | 2,807 | 2026-09-06 |
...
| # | Service | Loads |
|--:|---------|------:|
| 1 | cdnjs (Cloudflare CDN) | **501** |
| 2 | Google Analytics (GA4) | **473** |
| 3 | jsDelivr CDN | **429** |
| 4 | Google Tag Manager | **356** |
| 5 | jQuery | **253** |
| 6 | Font Awesome | **200** |
| 7 | Google Hosted Libraries | **158** |
| 8 | Google reCAPTCHA | **124** |
| 9 | unpkg CDN | **101** |
| 10 | Bootstrap | **55** |
| 11 | HubSpot | **29** |
| 12 | Sentry | **29** |
