...
_Stats as of 2026-06-06 06:25 UTC — last scan: 2026-06-06_

**116** scan batches run

**3,163** of **20,104** available pages scanned (**15.7%** coverage)
**2,381** of **3,163** scanned pages were reachable (**75.3%**)
**1,782** reachable pages loaded at least one third-party script (**74.8%** of reachable)
**2,913** known third-party service loads identified
...
|---------|---------|-----------|-----------|------------------------|--------------------|----------|
| Usa Edu Master | 3,163 | 3,763 | 2,381 | 1,782 | 2,913 | 2026-06-06 |
...
| # | Service | Loads |
|--:|---------|------:|
| 1 | cdnjs (Cloudflare CDN) | **536** |
| 2 | Google Analytics (GA4) | **495** |
| 3 | jsDelivr CDN | **410** |
