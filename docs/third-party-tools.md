...
**2,802** known third-party service loads identified
...
|---------|---------|-----------|-----------|------------------------|--------------------|----------|
| Usa Edu Master | 3,187 | 3,763 | 2,397 | 1,633 | 2,802 | 2026-08-31 |
...
| # | Service | Loads |
|--:|---------|------:|
| 1 | cdnjs (Cloudflare CDN) | **498** |
| 2 | Google Analytics (GA4) | **474** |
| 3 | jsDelivr CDN | **426** |
| 4 | Google Tag Manager | **351** |
| 5 | jQuery | **255** |
| 6 | Font Awesome | **199** |
