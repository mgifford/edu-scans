...
**2,806** known third-party service loads identified
...
|---------|---------|-----------|-----------|------------------------|--------------------|----------|
| Usa Edu Master | 3,187 | 3,763 | 2,397 | 1,633 | 2,806 | 2026-09-01 |
...
| # | Service | Loads |
|--:|---------|------:|
| 1 | cdnjs (Cloudflare CDN) | **504** |
| 2 | Google Analytics (GA4) | **474** |
| 3 | jsDelivr CDN | **425** |
