...
_Generated: 2026-08-23 05:44 UTC_

This report tracks how far along each scan type is across all countries. It is regenerated automatically after every scan run.

## Overall Coverage

Coverage is measured as pages scanned out of **20,142** pages available in the seed files.

| Scan Type | Pages Scanned | Available | Coverage |
|-----------|--------------|-----------|----------|
| **Combined Reachability** | **11,141 confirmed reachable** | 20,142 | **<span role="img" aria-label="55.3% complete" style="display:inline-flex;align-items:center;gap:4px;vertical-align:middle;"><span style="display:inline-block;width:120px;height:12px;background:#e2e8f0;border-radius:2px;overflow:hidden;"><span style="display:block;width:66px;height:100%;background:#b45309;"></span></span><span style="font-size:0.85em;color:#374151;">55.3%</span></span>** |
| Social Media | 13,058 scanned (11,141 reachable) | 20,142 | <span role="img" aria-label="64.8% complete" style="display:inline-flex;align-items:center;gap:4px;vertical-align:middle;"><span style="display:inline-block;width:120px;height:12px;background:#e2e8f0;border-radius:2px;overflow:hidden;"><span style="display:block;width:78px;height:100%;background:#b45309;"></span></span><span style="font-size:0.85em;color:#374151;">64.8%</span></span> |
| Technology | 13,058 scanned | 20,142 | <span role="img" aria-label="64.8% complete" style="display:inline-flex;align-items:center;gap:4px;vertical-align:middle;"><span style="display:inline-block;width:120px;height:12px;background:#e2e8f0;border-radius:2px;overflow:hidden;"><span style="display:block;width:78px;height:100%;background:#b45309;"></span></span><span style="font-size:0.85em;color:#374151;">64.8%</span></span> |
| Lighthouse | 3,431 scanned | 20,142 | <span role="img" aria-label="17.0% complete" style="display:inline-flex;align-items:center;gap:4px;vertical-align:middle;"><span style="display:inline-block;width:120px;height:12px;background:#e2e8f0;border-radius:2px;overflow:hidden;"><span style="display:block;width:20px;height:100%;background:#b91c1c;"></span></span><span style="font-size:0.85em;color:#374151;">17.0%</span></span> |
| Accessibility Statements | 12,107 domains | 20,142 | <span role="img" aria-label="60.1% complete" style="display:inline-flex;align-items:center;gap:4px;vertical-align:middle;"><span style="display:inline-block;width:120px;height:12px;background:#e2e8f0;border-radius:2px;overflow:hidden;"><span style="display:block;width:72px;height:100%;background:#b45309;"></span></span><span style="font-size:0.85em;color:#374151;">60.1%</span></span> |
| Third-Party JS | 3,078 scanned | 20,142 | <span role="img" aria-label="15.3% complete" style="display:inline-flex;align-items:center;gap:4px;vertical-align:middle;"><span style="display:inline-block;width:120px;height:12px;background:#e2e8f0;border-radius:2px;overflow:hidden;"><span style="display:block;width:18px;height:100%;background:#b91c1c;"></span></span><span style="font-size:0.85em;color:#374151;">15.3%</span></span> |
...
| 2026-08-20 | 60.3% | 65.3% | 65.3% | 15.4% | 0.0% |
| 2026-08-19 | 50.7% | 65.3% | 65.3% | 14.8% | 0.0% |
...
|---|---|---|---|
| Other | 1,161 | 1,150 | 99% |
| East Mississippi Community College | 136 | 136 | 100% |
| Home Ozarka College | 135 | 134 | 99% |
| Frederick Community College | 134 | 134 | 100% |
| American International University - Bangladesh | 131 | 131 | 100% |
| AKKINENI NAGESWARA RAO COLLEGE,GUDIVADA | 130 | 130 | 100% |
| California State University | 54 | 49 | 91% |
...
| Georgia State University | 40 | 40 | 100% |
| Florida International University | 39 | 39 | 100% |
| Georgia Institute of Technology | 38 | 37 | 97% |
...
| Des Moines Area Community College | 21 | 21 | 100% |
| Bard College | 20 | 20 | 100% |
| Barton County Community College | 20 | 20 | 100% |
| Colorado State University | 19 | 18 | 95% |
...
| Assumption University of Thailand | 17 | 17 | 100% |
...
|---------|---------|-----------|-----------|-------------|--------|-------|-----------|---------|---|---------|----------|-------------|
| Usa Edu Master | 3,749 | 3,763 | 2,807 | 1,153 | 7 | 646 | 1,001 | 935 | 320 | 51 | 636 | Aug 2026 |
| Usa Edu Master Subdomains | 9,209 | 16,279 | 8,246 | 3,133 | 27 | 1,192 | 3,894 | 2,285 | 966 | 79 | 1,193 | Aug 2026 |
| Usa Edu Top100 | 100 | 100 | 88 | 28 | 0 | 35 | 25 | 38 | 19 | 8 | 32 | Aug 2026 |
...
|---------|-------------|----------|
| Usa Edu Master | 3,749 | 2026-08-18 |
| Usa Edu Master Subdomains | 9,209 | 2026-08-18 |
| Usa Edu Top100 | 100 | 2026-08-18 |

## Lighthouse Scan by Country

| Country | URLs | Perf | A11y | Best Practices | SEO | Last Scan |
|---------|------|------|------|----------------|-----|----------|
| Usa Edu Master Subdomains | 3,341 | 89 | 90 | 78 | 84 | 2026-08-22 |
...
|---------|---------|-----------|--------------|-----------|------------|-------------|
| Usa Edu Master | 3,780 | 2,827 | 1,124 | 943 | 40% | Aug 2026 |
| Usa Edu Master Subdomains | 8,226 | 7,255 | 2,466 | 1,891 | 34% | Aug 2026 |
...
| Country | URLs Scanned | Last Scan |
|---------|-------------|----------|
| Usa Edu Master | 3,078 | 2026-08-23 |
