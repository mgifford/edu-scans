...
Coverage is measured as pages scanned out of **19,984** pages available in the seed files.

| Scan Type | Pages Scanned | Available | Coverage |
|-----------|--------------|-----------|----------|
| **Combined Reachability** | **11,141 confirmed reachable** | 19,984 | **<span role="img" aria-label="55.7% complete" style="display:inline-flex;align-items:center;gap:4px;vertical-align:middle;"><span style="display:inline-block;width:120px;height:12px;background:#e2e8f0;border-radius:2px;overflow:hidden;"><span style="display:block;width:67px;height:100%;background:#b45309;"></span></span><span style="font-size:0.85em;color:#374151;">55.7%</span></span>** |
| Social Media | 13,058 scanned (11,141 reachable) | 19,984 | <span role="img" aria-label="65.3% complete" style="display:inline-flex;align-items:center;gap:4px;vertical-align:middle;"><span style="display:inline-block;width:120px;height:12px;background:#e2e8f0;border-radius:2px;overflow:hidden;"><span style="display:block;width:78px;height:100%;background:#b45309;"></span></span><span style="font-size:0.85em;color:#374151;">65.3%</span></span> |
| Technology | 13,058 scanned | 19,984 | <span role="img" aria-label="65.3% complete" style="display:inline-flex;align-items:center;gap:4px;vertical-align:middle;"><span style="display:inline-block;width:120px;height:12px;background:#e2e8f0;border-radius:2px;overflow:hidden;"><span style="display:block;width:78px;height:100%;background:#b45309;"></span></span><span style="font-size:0.85em;color:#374151;">65.3%</span></span> |
| Lighthouse | 1,445 scanned | 19,984 | <span role="img" aria-label="7.2% complete" style="display:inline-flex;align-items:center;gap:4px;vertical-align:middle;"><span style="display:inline-block;width:120px;height:12px;background:#e2e8f0;border-radius:2px;overflow:hidden;"><span style="display:block;width:9px;height:100%;background:#b91c1c;"></span></span><span style="font-size:0.85em;color:#374151;">7.2%</span></span> |
| Accessibility Statements | 12,107 domains | 19,984 | <span role="img" aria-label="60.6% complete" style="display:inline-flex;align-items:center;gap:4px;vertical-align:middle;"><span style="display:inline-block;width:120px;height:12px;background:#e2e8f0;border-radius:2px;overflow:hidden;"><span style="display:block;width:73px;height:100%;background:#b45309;"></span></span><span style="font-size:0.85em;color:#374151;">60.6%</span></span> |
| Third-Party JS | 3,071 scanned | 19,984 | <span role="img" aria-label="15.4% complete" style="display:inline-flex;align-items:center;gap:4px;vertical-align:middle;"><span style="display:inline-block;width:120px;height:12px;background:#e2e8f0;border-radius:2px;overflow:hidden;"><span style="display:block;width:18px;height:100%;background:#b91c1c;"></span></span><span style="font-size:0.85em;color:#374151;">15.4%</span></span> |
...
| Usa Edu Master Subdomains | 9,209 | 16,121 | 8,246 | 3,133 | 27 | 1,192 | 3,894 | 2,285 | 966 | 79 | 1,193 | Aug 2026 |
...
|---------|------|------|------|----------------|-----|----------|
| Usa Edu Master Subdomains | 1,356 | 87 | 90 | 79 | 85 | 2026-08-21 |
| Usa Edu Top100 | 89 | 87 | 95 | 69 | 93 | 2026-08-21 |
...
| Country | URLs Scanned | Last Scan |
|---------|-------------|----------|
| Usa Edu Master | 3,071 | 2026-08-22 |
